...
class CSV:
    ...
    def get_transactions(cls, start_date, end_date):
        ...
        if filtered_df.empty:
            ...
            print(f"Net Savings: Ksh{(total_income - total_expense):.2f}")
...
def plot_transactions(df):
    ...
    plt.xlabel("Date")
    plt.ylabel("Amount")
    plt.title('Your Income and Expenses Over Time')
    plt.legend()
    plt.grid(True)
    plt.show()
...
def main():
    while True:
        ...
        print("2. View transactions and summary within time range")
        print("3. Exit")
